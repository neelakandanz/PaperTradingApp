// Define the class for your candlestick data
class CandleData {
  final DateTime date;
  final double open;
  final double high;
...
// Convert the stock data to a list of CandleData
List<CandleData> getCandleData() {
  ...
  return timeSeries.entries.map((entry) {
    ...
    final values = entry.value as Map<String, String>;
    ...
    return CandleData(date, open, high, low, close);
  }).toList();
}
